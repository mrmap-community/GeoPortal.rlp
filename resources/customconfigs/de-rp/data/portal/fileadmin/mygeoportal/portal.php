...
//$url=$page['path'];
//TODO following is not secure - don't use it in productive environments without https!!!!!
...
<form class="mygeoportal" action="<?php print $url;?>" method="post" onsubmit="return chkForm(this);">
...
<?php print $DATA["Benutzername"]; ?>
<br class="clr" />

<label for="passwort"><?php print $L["Passwort"]; ?>*</label>
<input class="text" id="passwort" type="password" name="Passwort" maxlength="40" />
<br class="clr" />

<label for="passwortwiederholung"><?php print $L["Passwort2"]; ?>*</label>
...
<h2><span><?php print $L["GlossarAnzeigen"]; ?></span></h2>
...
<h2><span><?php print $L["SpatialActivate"]; ?></span></h2>
...
<h2><span><?php print $L["UserNewsletter"]; ?></span></h2>
...
<h2><span><?php print $L["UserSurvey"]; ?></span></h2>
