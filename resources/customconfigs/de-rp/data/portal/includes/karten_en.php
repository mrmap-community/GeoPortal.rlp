...
$e = new mb_notice("typo3:karten.html: getparams= lang=en&mb_user_myGui=".$GET);
?>
<script type="text/javascript">if(!document.cookie){alert("We use cookies to make this site better. Please activate them in your browser.")};</script>
<iframe src="http://<?php print $_SERVER["HTTP_HOST"];?>/mapbender/frames/index.php?lang=en&mb_user_myGui=<?php print $GET;?>" name="geop_map" width="100%" height="800" style="border:0px"></iframe>
