...
// Adressen
			...
			$output.='<h2><a href="'.$url.'&amp;cat=adressen" title="'.str_replace('###AREA###',$L['Adressen'],$L['alleErgebnisse']).'">'.$i.''.$L['Adressen'].'</a></h2>
...
// Info
			...
			$output.='<h2><a href="'.$url.'&amp;cat=info" title="'.str_replace('###AREA###',$L['Info'],$L['alleErgebnisse']).'">'.$i.''.$L['Info'].'</a></h2>
				<div id="search-container-'.$name.'">
				'.$out[$name].'
				</div>';
