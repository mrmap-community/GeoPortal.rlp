...
<input type="hidden" name="searchid" value="<?php print $_REQUEST["searchid"];?>" />
<input type="hidden" name="selectsearch" value="<?php print $_REQUEST["selectsearch"];?>" />
<input type="hidden" name="cat" value="<?php print $_REQUEST["cat"];?>" />
<input type="hidden" name="uid" value="<?php print $_REQUEST["uid"];?>" />
