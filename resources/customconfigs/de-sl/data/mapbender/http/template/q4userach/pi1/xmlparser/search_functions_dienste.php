...
//			}
	...
	if($counter!=0) {
		if($startpage) {
			...
			$out[$name].='<a href="#" onclick="location.href=location.pathname+\'?searchid='.$_REQUEST['searchid'].'&amp;selectsearch=1&amp;uid='.$_REQUEST['uid'].'&amp;cat=dienste\';return false">Die ersten '.$countMembers.' Treffer anzeigen.</a></p>';
		}
