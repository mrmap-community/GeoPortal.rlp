...
<html lang="de" xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>www.geoportal.hessen.de | Metadaten</title>

		<base href="<?php print "http://".$_SERVER["SERVER_NAME"]."/portal/"; ?>" />

		<meta name="author" content="Q4U GmbH" />
		<meta name="publisher" content="Hessen" />
		<meta name="copyright" content="Hessen" />
		...
		<script type="text/javascript">
			function tou(tou) {
				fenster=window.open("/fileadmin/scripts/termsofuse.php?tou="+tou, "TermsOfUse", "width=700,height=500,left=25,top=25,scrollbars=yes,resizable=yes");
				fenster.focus();
				return false;
			}
		</script>
...
<body id="top" class="popup">
	...
	<a id="close" href="javascript:window.close()">Fenster schließen <img src="/fileadmin/design/icn_close.png" width="18" height="18" alt="" /></a>
		...
		<div id="center" class="content" style="padding:2em;width:90%;margin:0px;">
			...
			<p>
			Der Nutzer <?php print $DATA["Name"]; ?> (E-Mail: <?php print $DATA["EMail"]; ?>) beantragt ueber das Geoportal.Hessen die Freischaltung ihres Dienstes/Layers <?php print $_REQUEST["TITLE"]; ?> mit der ID <?php print $_REQUEST["ID"]; ?>.
			</p>
			...
			$Subject="Antragsstellung auf die Freigabe eines Dienstes im GeoPortal.Hessen";
			...
			$MailText='Der Nutzer '.$_REQUEST["Name"].' (E-Mail: '.$_REQUEST["EMail"].') beantragt ueber das Geoportal.Hessen
