...
// Krümelspur
if($language==0) {
	$ttnews_crumb="<a href=\"".realurl_link(1,false,$language)."\">Geoportal</a> &gt; <a href=\"".realurl_link(8,false,$language)."\">Aktuelles</a> &gt; ";
	$ttglossar_crump="<a href=\"".realurl_link(1,false,$language)."\">Geoportal</a> &gt; <a href=\"".realurl_link(10,false,$language)."\">Glossar</a> &gt; ";
} else {
	$ttnews_crumb="<a href=\"".realurl_link(1,false,$language)."\">Geoportal</a> &gt; <a href=\"".realurl_link(8,false,$language)."\">News</a> &gt; ";
	$ttglossar_crump="<a href=\"".realurl_link(1,false,$language)."\">Geoportal</a> &gt; <a href=\"".realurl_link(10,false,$language)."\">Glossary</a> &gt; ";
}
