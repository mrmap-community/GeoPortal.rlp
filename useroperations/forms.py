...
class RegistrationForm(forms.Form):
    name = forms.CharField(max_length=25, label=_("Username"), widget=forms.TextInput(attrs={'title':_("Please enter your username.")}))
    ...
    organization = forms.CharField(max_length=15, label=_("Organization"), required=False, widget=forms.TextInput(attrs={'title': _("Please enter the organization you are working for.")}))
    department = forms.CharField(max_length=50, label=_("Departement"), required=False, widget=forms.TextInput(attrs={'title':_("Please enter the departement you are working in.")}))
    phone = forms.CharField(max_length=20, label=_("Phone"), required=False,widget=forms.TextInput(attrs={'title': _("Please enter your phone number.")}))
...
class ChangeProfileForm(forms.Form):
    ...
    oldpassword = forms.CharField(widget=forms.PasswordInput(attrs={'title': _("Please enter your password.")}), label=_("Old password"))
